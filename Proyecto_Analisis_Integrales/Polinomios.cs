...
/* los coeficientes de las ecuaciones estan inversos...
 * esto es: a0->array[0], a1->array[1],...,aN->array[n]
 * sino seria an->array[0], esto es para aprovechar los atributos de los indices 
 * 
 * tl;dr:
 * 
 * coeficientes empiezan en a0 y terminan en an
 */
